...
class FDBObjectStore {
    ...
    set name(name) {
        ...
        transaction.db.objectStoreNames = new FakeDOMStringList(...Array.from(this._rawObjectStore.rawDatabase.rawObjectStores.keys())
    ...
    createIndex(name, keyPath, optionalParameters = {}) {
        ...
        this._rawObjectStore
            .saveStructure()
            .catch((err) => console.error("Error saving object store structure:", err));
